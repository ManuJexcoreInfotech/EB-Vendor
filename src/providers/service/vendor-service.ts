...
export class VendorService {
    ...
    load(params) {
        ...
        return new Promise(resolve => {
            this.http.get(this.config.setUrl('GET', '/wp-admin/admin-ajax.php?action=mstoreapp-getAllVendorProduct&', params)).map(res => res.json())
                .subscribe(data => {
                    //this.dismissLoading();
                    this.products = data;
    ...
    search(params) {
        return new Promise(resolve => {
            this.http.get(this.config.setUrl('GET', '/wp-json/wc/v2/products?', params)).map(res => res.json())
                .subscribe(data => {
                    this.products = data;
                    resolve(this.products);
                });
    ...
    getAttributes() {
        ...
        return new Promise(resolve => {
            this.http.get(this.config.setUrl('GET', '/wp-json/wc/v2/products/attributes?', false)).map(res => res.json())
                .subscribe(data => {
    ...
    attributeTerms(id) {
        ...
        return new Promise(resolve => {
            this.http.get(this.config.setUrl('GET', '/wp-json/wc/v2/products/attributes/' + id + '/terms?', false)).map(res => res.json())
                .subscribe(data => {
